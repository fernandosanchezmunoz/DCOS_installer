...
#
# Usage:
# sudo su, then "bash dcos_installer_rhel7.sh"
#
...
CLUSTERNAME=""DCOS_@_"$(hostname -d)"$(hostname -d)
...
yum install -y \
ftp://ftp.pbone.net/mirror/ftp.scientificlinux.org/linux/scientific/7.1/x86_64/os/Packages/libtool-ltdl-2.4.2-20.el7.x86_64.rpm \
ftp://bo.mirror.garr.it/1/slc/centos/7.1.1503/updates/x86_64/Packages/ipset-libs-6.19-4.el7.x86_64.rpm \
