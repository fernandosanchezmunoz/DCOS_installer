...
#print message to copy&paste in the agents
  ...
  echo -e "${RED}sudo su"
  echo -e "cd"
  echo -e "curl -O http://$BOOTSTRAP_IP:$BOOTSTRAP_PORT/$CEPH_CONF $CEPH_CONF"    
  echo -e "curl -O http://$BOOTSTRAP_IP:$BOOTSTRAP_PORT/$CEPH_MON_KEYRING $CEPH_MON_KEYRING"
  echo -e "curl -O http://$BOOTSTRAP_IP:$BOOTSTRAP_PORT/$CEPH_CLIENT_ADMIN_KEYRING $CEPH_CLIENT_ADMIN_KEYRING"
  echo -e "curl -O http://$BOOTSTRAP_IP:$BOOTSTRAP_PORT/$CEPH_INSTALLER && sudo bash $CEPH_INSTALLER"
  echo -e ""
  echo -e "${BLUE}** Done${NC}."
